...
- **No verificado en vivo de punta a punta** (resolución real de cuenta/ubicación, lectura de horario real, sobrescritura en producción): ningún negocio tiene todavía la aprobación de Google necesaria. Se verificó el type-check del panel y la función pura de mapeo de horarios con casos de prueba aislados; queda pendiente confirmar en Cloudflare que la nueva sección del panel carga bien y que el botón "Conectar" llega a la pantalla de consentimiento de Google.
